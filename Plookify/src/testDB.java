...
public class testDB {
  public static void main( String args[] )
  {
    ...
    try {
      ...
      c = DriverManager.getConnection("jdbc:sqlite:/Users/Ishrat/Desktop/Software Engineering Project/NetBeansProjects/SE21/Plookify/src/songDB");//connection to db, (db should be located in src)
